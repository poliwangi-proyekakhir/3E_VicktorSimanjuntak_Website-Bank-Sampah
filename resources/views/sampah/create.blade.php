            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        @endif
                        <form action="{{route('sampah.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sampah-form">
                            @csrf
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="jenis_sampah"  class="form-control"></div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-1 col-md-1"><input type="number" id="text-input" name="satuan" placeholder="1" value="1" class="form-control"></div>
                            </div>
